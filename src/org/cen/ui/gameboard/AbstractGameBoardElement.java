...
public abstract class AbstractGameBoardElement implements IGameBoardElement {
	 ...
	 *            the orientation of the element in radians
	 */
	public AbstractGameBoardElement(String name, Point2D position, double orientation) {
	 ...
	 */
	public AbstractGameBoardElement(String name, Point2D position, double orientation, int order) {
		super();
		this.name = name;
